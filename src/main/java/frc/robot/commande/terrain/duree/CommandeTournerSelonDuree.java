...
public class CommandeTournerSelonDuree extends Command {
    ...
    {
        //System.out.println("new CommandeTournerSelonDuree()");
        this.temps = temps;
    ...
    public void end(boolean interrupted) {
        System.out.println("CommandeTournerSelonDuree.end()");
