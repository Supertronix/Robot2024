...
const int CHOIX_WAVE = 0;
const int CHOIX_5910 = 1;
const int CHOIX_COMMANDITAIRE = 2;
const int CHOIX_DAMIER = 3;
const int CHOIX_AUCUN = 4;
const int CHOIX_VICTORY = 5;
const int CHOIX_LOST = 6;
...
int boucle = 0;
int tour = 0;
int duree = 60000; // 60000 millisecondes = 1 minute
void loop(){
  switch(choix)
  {
    case CHOIX_WAVE :
  ...
  boucle++;
  tour = (boucle/duree)%4; // car il y a 4 choix fonctionnels
